...
export default {
  ...
  methods: {
    ...
    async subReview() {
      ...
      const res = await fetch(`http://54.83.141.77:3001/review/create`, {
        method: "POST",
        credentials: "include",
        headers: {
    ...
    async getReview() {
      const res = await fetch(
        `http://54.83.141.77:3001/review/all?storeId=${this.id}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  async created() {
    ...
    const res = await fetch(`http://54.83.141.77:3001/store/id/${id}`, {
      method: "GET",
      credentials: "include",
      headers: {
        "Content-type": "application/json",
