...
export default {
  ...
  methods: {
    async getPosts() {
      const res = await fetch('http://3.92.58.10:3001/post/all', {
        method: 'GET',
        credentials: 'include',
        headers: {
    ...
    async post(e) {
      ...
      //http://3.92.58.10:3001/post/create
      const post_create = await fetch('http://3.92.58.10:3001/post/create', {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json',
  ...
  async created() {
    const res = await fetch('http://3.92.58.10:3001/auth/me', {
      method: 'GET',
      credentials: 'include',
      headers: {
        'Content-type': 'application/json',
